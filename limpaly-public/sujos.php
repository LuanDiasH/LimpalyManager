...
<body>
    ...
    <div class="container col-12" >
                <div id="breadcrumb" class="col-md-12 mt-5 text-center">
                    <h3 class="mt-3 mb-4 text-white">Quartos Sujos:</h3>
                    <nav id="breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item "><a href="todos.php">Todos</a></li>
                            <li class="breadcrumb-item active"><a href="sujos.php">Sujos</a></li>
                    ...
                    <?php else : ?>
                        <p >Não há quartos <span class="text-primary">SUJOS</span> no momento.</p>
                    <?php endif; ?>
                </div>
