...
<body>
    ...
    <div class="container text-white mt-3 align-items-center justify-content-center" id="tudo" >
        <div class="col-12 col-md-6 col-lg-4" id="card-login">
            <div>
                <img src="img/negado.png" class="img-fluid" alt="">
                <h1 class="bitter">Acesso negado</h1>
                <p class="concert-one-regular">Você não tem permissão para acessar esta página. </p>
                <p class="concert-one-regular">Faça <span><a href="login.php">login</a></span> para continuar.</p>
            </div>
