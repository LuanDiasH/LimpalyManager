...
<body>
    ...
    <div class="container col-12" >
                <div id="breadcrumb" class="col-md-12 mt-5 text-center">
                    <h3 class="mt-3 mb-4 text-white">Quartos Limpos:</h3>
                    <nav id="breadcrumb" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" ><a href="limpos.php">Limpos</a></li>
                    ...
                    <?php else : ?>
                        <p>Não há quartos <span class="text-primary">LIMPOS</span> no momento.</p>
                    <?php endif; ?>
                </div>
